/**
 * E2E Test Suite 1: Complete Ride Lifecycle
 *
...
test.describe('Ride Lifecycle - Complete User Journey', () => {
  ...
  test('complete ride lifecycle: create, join, approve, message, leave, delete', async ({ twoUsers }) => {
    ...
    // ============================================
    // STEP 2: Owner verifies ride appears in MyRides (Created section)
    // ============================================
    ...
    // ============================================
    // STEP 3: Joiner finds the ride (with retry logic)
    // ============================================
    ...
    // ============================================
    // STEP 4: Joiner requests to join the ride
    // ============================================
    ...
    // ============================================
    // STEP 5: Joiner verifies ride appears in MyRides (Requested section)
    // ============================================
    ...
    // ============================================
    // STEP 6: Owner approves the join request
    // ============================================
    await ownerMyRidesPage.goto();
    await ownerMyRidesPage.waitForLoad();
    ...
    // ============================================
    // STEP 7: Joiner verifies they're now in the Joined section
    // ============================================
    await joiner.page.waitForTimeout(1000);
    await joinerMyRidesPage.goto();
    await joinerMyRidesPage.waitForLoad();
    ...
    // ============================================
    // STEP 8: Test messaging between users (optional - skip if not visible)
    // ============================================
    ...
    // ============================================
    // STEP 10: Owner deletes the ride
    // ============================================
    await ownerMyRidesPage.goto();
    await ownerMyRidesPage.waitForLoad();
